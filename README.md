...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>
        Leitor e editor universal de arquivos <strong>standalone e 100% offline</strong> para terminal, com pager TUI interativo, busca em tempo real (<code>/</code>), sumário navegável TOC (<code>t</code>), edição com <code>Ctrl+S</code>, modo watch e exportação HTML estática autocontida.
      </p>
      <p>
